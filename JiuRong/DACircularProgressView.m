...
//    self.progressLabel = [[UILabel alloc]initWithFrame:CGRectMake(rect.size.width/2.0-10, rect.size.height/2.0-7.5, 60, 15)];
...
{
    _progress = progress;
//    self.progressLabel.text = [NSString stringWithFormat:@"%.1lf%%",progress*100];
